...
class UVGustitosApp:
    ...
    def mostrar_menu_restaurante(self, restaurante):
        ...
        tk.Button(self.frame_menu, text="Hacer Pedido", command=lambda: self.mostrar_resumen_pedido(restaurante), bg="#6C8EAD", fg="black", font=("Arial", 14)).pack(pady=10)
        tk.Button(self.frame_menu, text="Regresar a Restaurantes", command=self.mostrar_pantalla_restaurantes_consumidor, bg="#6C8EAD", fg="black", font=("Arial", 14)).pack(pady=10)
